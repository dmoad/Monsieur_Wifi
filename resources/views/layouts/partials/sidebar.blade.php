    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item {{ request()->is('*/devices', '*/appareils') ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="/{{ $locale === 'fr' ? 'fr/appareils' : 'en/devices' }}"><i data-feather="hard-drive"></i><span class="menu-title text-truncate">{{ __('sidebar.devices') }}</span></a>
            </li>
            ...
            <li class="nav-item {{ request()->is('*/shop', '*/boutique', '*/cart', '*/panier', '*/checkout', '*/commander') ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="/{{ $locale === 'fr' ? 'fr/boutique' : 'en/shop' }}"><i data-feather="shopping-bag"></i><span class="menu-title text-truncate">{{ __('sidebar.shop') }}</span></a>
            </li>
            ...
            <li class="nav-item only_superadmin hidden {{ request()->is('*/qos-settings', '*/parametres-qos') ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="/{{ $locale === 'fr' ? 'fr/parametres-qos' : 'en/qos-settings' }}"><i data-feather="sliders"></i><span class="menu-title text-truncate">{{ __('sidebar.traffic_priority') }}</span></a>
            </li>
            <li class="nav-item admin_and_above hidden {{ request()->is('*/admin/models', '*/admin/modeles') ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="/{{ $locale === 'fr' ? 'fr/admin/modeles' : 'en/admin/models' }}"><i data-feather="cpu"></i><span class="menu-title text-truncate">{{ __('sidebar.manage_models') }}</span></a>
            </li>
            <li class="nav-item admin_and_above hidden {{ request()->is('*/admin/inventory', '*/admin/inventaire') ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="/{{ $locale === 'fr' ? 'fr/admin/inventaire' : 'en/admin/inventory' }}"><i data-feather="box"></i><span class="menu-title text-truncate">{{ __('sidebar.manage_inventory') }}</span></a>
            </li>
            <li class="nav-item admin_and_above hidden {{ request()->is('*/admin/orders', '*/admin/commandes') ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="/{{ $locale === 'fr' ? 'fr/admin/commandes' : 'en/admin/orders' }}"><i data-feather="package"></i><span class="menu-title text-truncate">{{ __('sidebar.manage_orders') }}</span></a>
            </li>
            ...
            <li class="nav-item {{ request()->is('*/orders', '*/commandes') ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="/{{ $locale === 'fr' ? 'fr/commandes' : 'en/orders' }}"><i data-feather="list"></i><span class="menu-title text-truncate">{{ __('sidebar.my_orders') }}</span></a>
            </li>
            <li class="nav-item">

...
<head>
    ...
    <title>Mes Commandes - Monsieur WiFi</title>
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                <li class="nav-item dropdown dropdown-language">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="/en/orders"><i class="flag-icon flag-icon-us"></i> English</a>
                        <a class="dropdown-item" href="/fr/commandes"><i class="flag-icon flag-icon-fr"></i> Français</a>
                    </div>
                </li>
            ...
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-3 col-12">
                    <a href="/fr/boutique" class="btn btn-primary">
                        <i data-feather="shopping-bag"></i> Continuer les Achats
                    </a>
                </div>
            </div>
                ...
                <div id="orders-empty" style="display: none;">
                    <div class="card">
                        <div class="card-body text-center py-5">
                            ...
                            <p>Commencez à magasiner pour voir vos commandes ici!</p>
                            <a href="/fr/boutique" class="btn btn-primary">Magasiner Maintenant</a>
                        </div>
                    </div>
                </div>
    ...
    <script src="/assets/js/orders-fr.js?v=<?php echo time(); ?>"></script>
    <script>

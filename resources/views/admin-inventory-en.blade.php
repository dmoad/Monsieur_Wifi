    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="text-muted">
                <small><i data-feather="info" style="width: 14px; height: 14px;"></i> Click <strong>"Add/View Devices"</strong> button to add inventory items. MAC addresses are automatically normalized to UPPERCASE with "-" delimiter.</small>
            </div>
        </div>
        <div class="card-body">
            <div class="row">

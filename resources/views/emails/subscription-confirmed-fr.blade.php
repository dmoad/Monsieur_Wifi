        ...
        <div class="content">
            ...
            <div class="subscription-details">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="padding: 10px 0; {{ !empty($subscriptionData['trial_end']) || !empty($subscriptionData['deposit_amount']) ? 'border-bottom: 1px solid #e0e0e0;' : '' }} color: #666; font-size: 14px;">Date de d&eacute;but</td>
                        <td style="padding: 10px 0; {{ !empty($subscriptionData['trial_end']) || !empty($subscriptionData['deposit_amount']) ? 'border-bottom: 1px solid #e0e0e0;' : '' }} color: #333; font-weight: 600; font-size: 14px; text-align: right;">{{ $subscriptionData['start_date'] }}</td>
                    </tr>
                    @if(!empty($subscriptionData['trial_end']))
                    <tr>
                        <td style="padding: 10px 0; border-bottom: 1px solid #e0e0e0; color: #666; font-size: 14px;">P&eacute;riode d'essai jusqu'au</td>
                        <td style="padding: 10px 0; border-bottom: 1px solid #e0e0e0; color: #28a745; font-weight: 600; font-size: 14px; text-align: right;">{{ $subscriptionData['trial_end'] }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px 0; border-bottom: 1px solid #e0e0e0; color: #666; font-size: 14px;">Premi&egrave;re facturation</td>
                        <td style="padding: 10px 0; border-bottom: 1px solid #e0e0e0; color: #333; font-weight: 600; font-size: 14px; text-align: right;">{{ $subscriptionData['trial_end'] }}</td>
                    </tr>
                    @endif
                    @if(!empty($subscriptionData['deposit_amount']))
                    <tr>
                        <td style="padding: 10px 0; border-bottom: 1px solid #e0e0e0; color: #666; font-size: 14px;">Caution</td>
                        <td style="padding: 10px 0; border-bottom: 1px solid #e0e0e0; color: #333; font-weight: 600; font-size: 14px; text-align: right;">{{ $subscriptionData['deposit_amount'] }}</td>
                    </tr>
                    @endif
                    @if(!empty($subscriptionData['shipping_fee']))
                    <tr>
                        <td style="padding: 10px 0; color: #666; font-size: 14px;">Frais de livraison</td>
                        <td style="padding: 10px 0; color: #333; font-weight: 600; font-size: 14px; text-align: right;">{{ $subscriptionData['shipping_fee'] }}</td>
                    </tr>
                    @endif
                </table>
            </div>

...
<body>
    <div class="container">
        <div class="header"><h1>📦 Votre Commande a été Expédiée!</h1></div>
        <div class="content">
            <p>Bonjour {{ $order->user->name }},</p>
            <p>Bonne nouvelle! Votre commande <strong>#{{ $order->order_number }}</strong> a été expédiée et est en route.</p>
            <div class="tracking-box">
                <p style="margin: 0 0 10px 0;"><strong>Transporteur:</strong> {{ $order->shipping_provider }}</p>
                <p style="margin: 0 0 10px 0;"><strong>Numéro de Suivi:</strong></p>

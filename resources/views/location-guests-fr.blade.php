...
<head>
    ...
    <title>Invités de l'emplacement - monsieur-wifi Controller</title>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item only_admin hidden">
                    <a class="d-flex align-items-center" href="/fr/domain-blocking">
                        ...
                        <span class="menu-title text-truncate">Blocage de domaine</span>
                    </a>
                </li>
                <li class="nav-item only_admin hidden">
                    <a class="d-flex align-items-center" href="/fr/firmware">
                        <i data-feather="download"></i>
                        <span class="menu-title text-truncate">Micrologiciel</span>
                    </a>
                </li>
                <li class="nav-item only_admin hidden">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0" id="location-name">Invités de l'emplacement</h2>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            guestsTable = $('#guests-table').DataTable({
                ...
                language: {
                    ...
                    zeroRecords: 'Aucun invité correspondant trouvé',
                    processing: '<div class="spinner-border text-primary" role="status"><span class="sr-only">Chargement...</span></div>'
                }
            });
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (location && location.name) {
                        $('#location-name').text(location.name + ' - Invités');
                    }
                },
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success && response.data) {
                        ...
                        toastr.error('Erreur lors du chargement des données des invités');
                    }
                },
                error: function(xhr, status, error) {
                    ...
                    if (xhr.status === 401) {
                        ...
                        toastr.error('Échec du chargement des données des invités');
                    }
                }
            });
        }
        ...
        function exportToCSV() {
            ...
            .then(blob => {
                ...
                toastr.success('Export CSV démarré');
            })
            .catch(error => {
                console.error('Export error:', error);
                toastr.error('Échec de l\'export CSV');
            });
        }
    </script>
</body>

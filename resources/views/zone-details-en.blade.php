...
@section('title', 'Zone Details - Monsieur WiFi')
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Zone Details</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/en/dashboard">Home</a></li>
                        <li class="breadcrumb-item"><a href="/en/zones">Zones</a></li>
                        <li class="breadcrumb-item active" id="zone-breadcrumb">Loading...</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content-header-right col-md-3 col-12 text-right d-flex justify-content-end gap-2">
        <button class="btn btn-outline-primary" onclick="editZone()">
            <i data-feather="edit"></i> Edit Zone
        </button>
    </div>
</div>
    ...
    <div id="zone-content" style="display: none;">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Locations in Zone</h4>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Add Location to Zone</h4>
            </div>
            <div class="card-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <form id="edit-zone-form">
                    ...
                    <div class="form-group">
                        <div class="d-flex align-items-center mb-1">
                            <label class="mb-0 font-weight-bold mr-2" for="edit-zone-roaming-enabled">Roaming</label>
                    ...
                    <div class="form-group" id="edit-zone-owner-group" style="display:none;">
                        ...
                        <small class="form-text text-muted">Change the owner of this zone. All locations in the zone must belong to the new owner.</small>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="updateZoneInfo()">Save Changes</button>
            </div>
        </div>
    </div>
</div>

...
<head>
    ...
    <title>Panier - Monsieur WiFi</title>
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                <li class="nav-item dropdown dropdown-language">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="/en/cart"><i class="flag-icon flag-icon-us"></i> English</a>
                        <a class="dropdown-item" href="/fr/panier"><i class="flag-icon flag-icon-fr"></i> Français</a>
                    </div>
                </li>
            ...
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-3 col-12">
                    <a href="/fr/boutique" class="btn btn-outline-primary">
                        <i data-feather="arrow-left"></i> Continuer les Achats
                    </a>
                </div>
            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/fr/commander" class="btn btn-primary btn-block">Passer à la Caisse</a>
                            </div>
                        </div>
                    </div>
                </div>

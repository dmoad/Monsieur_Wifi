...
<head>
    ...
    <title>Caisse - Monsieur WiFi</title>
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="">
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Caisse</h2>
                                ...
                                <form id="checkout-form">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="same_as_shipping">L'adresse de facturation est la même que l'adresse de livraison</label>
                                        </div>
                                    </div>
    ...
    <script src="/assets/js/checkout-fr.js?v=<?php echo time() + 3; ?>"></script>
    <script>

...
<head>
    ...
    <title>Gérer les commandes - Monsieur WiFi</title>
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                <li class="nav-item dropdown dropdown-language">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="/en/admin/orders"><i class="flag-icon flag-icon-us"></i> English</a>
                        <a class="dropdown-item" href="/fr/admin/commandes"><i class="flag-icon flag-icon-fr"></i> Français</a>
                    </div>
                </li>
    ...
    <script>
        alert('Admin orders page loaded');
    </script>
    ...
    <script>
        ...
        // User display (authentication is handled by admin-orders.js)

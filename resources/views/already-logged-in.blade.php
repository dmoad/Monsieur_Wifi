...
<body>
    <div class="already-container">
        ...
        <h1 class="already-title">Already Connected</h1>
        <p class="already-message" id="already-message">You're already connected to the WiFi network. No need to log in again.</p>
        
        <a href="#" id="continue-button" class="action-button">
    ...
    <script>
        $(document).ready(function() {
            ...
            function applyDesignSettings(settings, design) {
                ...
                // Apply gradient to already container if gradient colors are available
                if (design.background_color_gradient_start && design.background_color_gradient_end) {
                    $('.already-container').css({
                ...
                if (design.already_connected_message) {
                    $('#already-message').text(design.already_connected_message);
                }

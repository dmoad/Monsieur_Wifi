...
<head>
    ...
    <meta name="description" content="Tableau de bord monsieur-wifi pour la gestion et la surveillance des réseaux WiFi.">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                <li class="nav-item dropdown dropdown-language">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-flag">
                        ...
                        <a class="dropdown-item" href="javascript:void(0);" data-language="fr"><i class="flag-icon flag-icon-fr"></i> Français</a>
                    </div>
                </li>

...
return [
    ...
    'mac_save_hint' => 'Add or remove entries, then click Save to apply.',
    'mac_save_btn' => 'Save',
    ...
    'js_scheduler' => [
        ...
        'hint' => 'Click an empty cell to create a slot. Drag to move, resize with the handles, hover to remove.',
        'days' => [
            'monday' => 'Monday',
            'tuesday' => 'Tuesday',
            'wednesday' => 'Wednesday',
        ...
        'msgOverlap' => 'Cannot create slot: overlaps with an existing slot.',

...
return [
    ...
    'confirm_delete_device_title' => 'Delete the access point too?',
    'confirm_delete_device' => 'This location has an access point ({mac}). Also delete the device? Choose "Keep device" to delete only the location.',
    ...
    'create_zone_placeholder' => 'e.g. Main office',

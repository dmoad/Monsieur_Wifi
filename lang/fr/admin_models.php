...
return [
    'page_title' => 'Gérer les Modèles - Monsieur WiFi',
    'heading' => 'Gérer les Modèles',
    'breadcrumb' => 'Gérer les Modèles',

    'btn_add_new' => 'Ajouter un Modèle',

    'filter_heading' => 'Filtrer les Modèles',
    ...
    'form_model_name' => 'Nom du Modèle',
    'form_device_type' => 'Type d\'Appareil',
    'form_select_type' => 'Sélectionner le Type',
    'form_price' => 'Prix ($)',
    'form_description_en' => 'Description (Anglais)',
    'form_description_fr' => 'Description (Français)',
    'form_sort_order' => 'Ordre de Tri',
    'form_product_images' => 'Images du Produit',
    'form_upload_image' => 'Télécharger une Image',
